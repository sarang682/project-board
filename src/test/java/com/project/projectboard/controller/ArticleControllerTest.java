...
class ArticleControllerTest {
    ...
    @Test
    public void givenSearchKeyword_whenSearchArticlesView_thenReturnsArticlesView() throws Exception {
        // Given
    ...
    @WithUserDetails(value = "sarangTest",setupBefore = TestExecutionEvent.TEST_EXECUTION)
